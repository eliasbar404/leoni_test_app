...
const userService = {
  ...
  createUser: async (formData: FormData) => {
    try {
      await api.post('/formateur/operateurs/create', formData, {
        headers: {
...
const CreateOperateurPage: React.FC = () => {
  // const [groupeId, setSelectedGroup] = useState<string | null>(null);
  ...
  value={formData.formateurId ?? null} // Pass the integer or null
...
export default CreateOperateurPage;
